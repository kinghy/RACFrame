...
-(void)formatView{
    ...
    //格式化手机字符串
    [[self.phoneNum rac_signalForControlEvents:UIControlEventEditingChanged] subscribeNext:^(UITextField* x){
        @strongify(_viewModel);
        x.text = [_viewModel formatMobile:x.text];
    }];
